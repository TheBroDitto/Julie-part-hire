...
def display_orders():
    ...
    print_order_window.configure(background="#c4fff9")
...
def hire_window(title_text, action_text):
    ...
    hire_window_instance.configure(background="#c4fff9")

    tk.Label(hire_window_instance, text="Name", bg="#c4fff9").grid(column=0, row=0, padx=10, pady=5, sticky='e')
    global enter_name
    ...
    tk.Label(hire_window_instance, text="Item to hire", bg="#c4fff9").grid(column=0, row=1, padx=10, pady=5, sticky='e')
    global enter_item
    enter_item = ttk.Combobox(hire_window_instance, values=items, width=17)
    enter_item.grid(column=1, row=1, padx=10, pady=5, sticky='w')

    tk.Label(hire_window_instance, text="Number of items hire", bg="#c4fff9").grid(column=0, row=2, padx=10, pady=5, sticky='e')
...
def return_window(title_text, action_text):
    ...
    return_window_instance.configure(background="#c4fff9")

    tk.Label(return_window_instance, text="Receipt number", bg="#c4fff9").grid(column=0, row=0, padx=10, pady=5, sticky='e')
    ...
    items = ["balloons", "banners", "confetti"]
    tk.Label(return_window_instance, text="Item to return", bg="#c4fff9").grid(column=0, row=1, padx=10, pady=5, sticky='e')
    ...
    tk.Label(return_window_instance, text="Number of items to return", bg="#c4fff9").grid(column=0, row=2, padx=10, pady=5, sticky='e')
...
main_window.configure(background="#c4fff9")


welcome = tk.Label(main_window, text="Welcome to Party Hire, Would you like to refund or hire an item?", bg="#c4fff9")
welcome.grid(row=0, column=0, pady=10)

ttk.Button(main_window, text="Hire", command=lambda: hire_window("Hire", "Order", bg="#3dccc7"), width=20).grid(row=1, column=0, pady=10)
