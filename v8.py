...
Hire_form = ttk.Button(main_frame, text="Hire", command=hire_window, width=20)
Hire_form.grid(row=1, column=0, pady=10)

Return_form = ttk.Button(main_frame, text="Returns/Refund", command=return_window, width=20)
Return_form.grid(row=2, column=0, pady=10)

Return_form = ttk.Button(main_frame, text="Check orders", command=display_orders, width=20) 
Return_form.grid(row=3, column=0, pady=10)

quit_button = ttk.Button(main_frame, text="Quit", command=quit_program, width=20)
